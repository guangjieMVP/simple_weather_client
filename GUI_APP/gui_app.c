...
void gui_app_start()
{
	...
	lv_theme_t *theme = lv_theme_zen_init(210, NULL);
	//;
	//lv_theme_night_init(100, NULL);
	lv_theme_set_current(theme);
	
//	//2.打开登录窗体
	login_win_create(lv_scr_act());
//	
//	lv_obj_t * back_btn = lv_label_create(lv_scr_act(), NULL);//用标签来模拟按钮
//	lv_label_set_text(back_btn, "test");//设置文本
